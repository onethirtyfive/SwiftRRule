...
//
//                    eachHasher.combine(RFCBimodalWeekDay.each(.monday))
//                    eachNHasher.combine(RFCBimodalWeekDay.eachN(.monday(3)))
//
//                    expect(
//                        eachHasher.finalize()
...
//                    ).to(equal(RFCBimodalWeekDayDetail.none))
//                }
//
...
//            }
//
//            describe("isByweeknoAdequate determination") {
...
//
//                    it("returns false") {
//                        expect(rfcRRuleDetails.isByweeknoAdequate).to(beFalse())
//                    }
//                }
//
...
//
//                    it("returns true") {
//                        expect(rfcRRuleDetails.isByweeknoAdequate).to(beTrue())
//                    }
//                }
//
...
//            }
//
//            describe("isByyeardayAdequate determination") {
...
//
//                    it("returns false") {
//                        expect(rfcRRuleDetails.isByyeardayAdequate).to(beFalse())
//                    }
//                }
//
...
//
//                    it("returns true") {
//                        expect(rfcRRuleDetails.isByyeardayAdequate).to(beTrue())
//                    }
//                }
//
...
//            }
//
//            describe("isBymonthdayAdequate determination") {
...
//
//                    it("returns false") {
//                        expect(rfcRRuleDetails.isBymonthdayAdequate).to(beFalse())
//                    }
//                }
//
...
//
//                    it("returns true") {
//                        expect(rfcRRuleDetails.isBymonthdayAdequate).to(beTrue())
//                    }
//                }
//
...
//            }
//
//            describe("isByweekdayAdequate determination") {
...
//
//                    it("returns false") {
//                        expect(rfcRRuleDetails.isByweekdayAdequate).to(beFalse())
//                    }
//                }
//
...
//
//                    it("returns true") {
//                        expect(rfcRRuleDetails.isByweekdayAdequate).to(beTrue())
//                    }
//                }
//
...
//
//                    it("returns true") {
//                        expect(rfcRRuleDetails.isAdequate).to(beTrue())
//                    }
//                }
//
//                context("when isByweeknoAdequate is false") {
//                    var rfcRRuleDetails: RFCRRuleDetails {
//                        get {
//                            var rfcRRuleDetails = RFCRRuleDetails()
//                            // rfcRRuleDetails.byweekno = .one(23)
...
//
//                    it("returns false") {
//                        expect(rfcRRuleDetails.isAdequate).to(beFalse())
//                    }
//                }
//
//                context("when isByyeardayAdequate is false") {
//                    var rfcRRuleDetails: RFCRRuleDetails {
//                        get {
//                            var rfcRRuleDetails = RFCRRuleDetails()
//                            rfcRRuleDetails.byweekno = .one(23)
...
//                }
//
//                context("when isBymonthdayAdequate is false") {
//                    var rfcRRuleDetails: RFCRRuleDetails {
//                        get {
//                            var rfcRRuleDetails = RFCRRuleDetails()
//                            rfcRRuleDetails.byweekno = .one(23)
...
//                let dtstart = "2021-01-01T00:00:00.815479Z".toDate()!.date
//
...
//                        expect(
//                            rfcRRuleDetails.normalized(.yearly, starting: dtstart)
...
//                            expect(anchored().bymonthday).to(equal(.one(dtstart.day)))
//                        }
//
...
//                                expect(
//                                    anchored().bymonth
//                                ).to(equal(.one(Month(rawValue: dtstart.month - 1)!)))
//                            }
//                        }
//                    }
//
...
//
//                        func anchored() -> RFCRRuleDetails {
//                            rfcRRuleDetails.normalized(.monthly, starting: dtstart)
//                        }
//
//                        it("sets bymonthday to one--that of dtstart's day number") {
//                            expect(
//                                anchored().bymonthday
//                            ).to(equal(.one(dtstart.day)))
//                        }
//
...
//
//                        func anchored() -> RFCRRuleDetails {
//                            rfcRRuleDetails.normalized(.weekly, starting: dtstart)
//                        }
//
...
//                                anchored().byweekday
//                            ).to(equal(
//                                .one(.each(WeekDay(rawValue: dtstart.weekday)!.rfcWeekDay))
//                            ))
//                        }
//
...
//
//                        func anchored() -> RFCRRuleDetails {
//                            rfcRRuleDetails.normalized(.daily, starting: dtstart)
//                        }
//
//                        it("does not change bymonth, bymonthday, or byweekday") {
//                            let _anchored = anchored()
